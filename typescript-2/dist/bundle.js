...
var TypeKeys;
(function (TypeKeys) {
    TypeKeys["INCREMENT_COUNTER"] = "INC";
    TypeKeys["DECREMENT_COUNTER"] = "DEC";
    TypeKeys["OTHER_ACTION"] = "__any_other_action_type__";
})(TypeKeys = exports.TypeKeys || (exports.TypeKeys = {}));
// END Actions
// START Action Creators
exports.incrementCounter = function (by) { return ({
    by: by,
    type: TypeKeys.INCREMENT_COUNTER,
}); };
exports.decrementCounter = function (by) { return ({
    by: by,
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(0);
var reducers_1 = __webpack_require__(25);
var actions_1 = __webpack_require__(8);
var store = redux_1.createStore(reducers_1.reducers);
store.subscribe(function () {
    console.log('[STATE UPDATE]', store.getState());
});
store.dispatch(actions_1.incrementCounter(1)); // { counter: { value: 1 } }
store.dispatch(actions_1.incrementCounter(1)); // { counter: { value: 2 } }
store.dispatch(actions_1.incrementCounter(1)); // { counter: { value: 3 } }
store.dispatch(actions_1.decrementCounter(1)); // { counter: { value: 2 } }
...
function counter(state, action) {
    ...
    switch (action.type) {
        case actions_1.TypeKeys.INCREMENT_COUNTER:
            return { value: state.value + action.by };
        case actions_1.TypeKeys.DECREMENT_COUNTER:
            return { value: state.value - action.by };
    }
    return state;
}
