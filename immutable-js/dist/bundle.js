...
/* harmony export (immutable) */ __webpack_exports__["a"] = ActionTypeKeys;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = incrementCounter;

const decrementCounter = (by) => ({
    by,
    type: ActionTypeKeys.DECREMENT_COUNTER,
})
/* harmony export (immutable) */ __webpack_exports__["b"] = decrementCounter;
...
const store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* createStore */])(__WEBPACK_IMPORTED_MODULE_1__reducers__["a" /* reducers */])

store.subscribe(() => {
    console.log('[STATE UPDATE]', store.getState())
})

store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_2__actions__["c" /* incrementCounter */])(1)) // { counter: { value: 1 } }
store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_2__actions__["c" /* incrementCounter */])(1)) // { counter: { value: 2 } }
store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_2__actions__["c" /* incrementCounter */])(1)) // { counter: { value: 3 } }
store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_2__actions__["b" /* decrementCounter */])(1)) // { counter: { value: 2 } }
 ...
 */
function counter(state = __WEBPACK_IMPORTED_MODULE_2__store__["a" /* INITIAL_STATE */], action) {
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_1__actions__["a" /* ActionTypeKeys */].INCREMENT_COUNTER:
            return state.updateIn(['value'], (value) => value + action.by);
        case __WEBPACK_IMPORTED_MODULE_1__actions__["a" /* ActionTypeKeys */].DECREMENT_COUNTER:
            return state.updateIn(['value'], (value) => value - action.by);
    }
    return state
}
...
/* unused harmony default export */ var _unused_webpack_default_export = (reducers);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_immutable__ = __webpack_require__(27);
...
const INITIAL_STATE = Object(__WEBPACK_IMPORTED_MODULE_0_immutable__["fromJS"])({
    value: 0,
})
/* harmony export (immutable) */ __webpack_exports__["a"] = INITIAL_STATE;
